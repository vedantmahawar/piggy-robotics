...
export default function Home() {
  return (
    <div>
      ...
      {/* Our Belief */}
      <div className="overflow-hidden mb-20 sm:mb-40">
        <div className="w-full border-b-2 border-dashed border-neutral-300 relative">
          ...
          />
          <div className="relative z-10 -my-[2px] w-full max-w-6xl mx-auto px-8 xl:px-0 text-balance text-left flex flex-row justify-center items-center bg-[#f9f9f9] border-l-2 border-r-2 border-t-4 border-b-2 border-neutral-300">
            <div className="ps-10">
      ...
      {/* Cost */}
      <div className="w-full max-w-6xl mx-auto px-8 xl:px-0 text-balance text-right rotate-90 -mt-50 -mb-10">
      ...
      {/* Technology */}
      <div className="w-full max-w-6xl mx-auto px-8 xl:px-0 mb-20 sm:mb-40 text-balance border-2 border-dashed border-neutral-300 p-10 bg-[#f9f9f9]">
        <div className="px-10 ">
          <h4 className="text-lg sm:text-normal font-medium mb-2 text-blue-500">
            Technology
          </h4>
      ...
      {/* The Competition */}
      <div className="w-full max-w-6xl mx-auto px-8 xl:px-0 mb-20 sm:mb-40 text-balance text-center p-10">
        <div className="px-10">
          <h4 className="text-lg sm:text-normal font-medium mb-2 text-blue-500">
            Comparison
          </h4>
      ...
      {/* Use Cases */}
      <div className="w-full max-w-6xl mx-auto px-8 xl:px-0 mb-20 sm:mb-40 text-balance text-left p-10">
        <div className="px-10">
          <h4 className="text-lg sm:text-normal font-medium mb-2 text-blue-500">
            Use Cases
          </h4>
          ...
          <h3 className="text-lg sm:text-xl font-normal mb-10 text-neutral-500">
            ...
            is filled with places mass-produced humanoids could make accessible
            to humanity.
          </h3>

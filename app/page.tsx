  ...
  return (
    <div>
      <div className="relative">
        <DotPattern glow={false} className="-z-20 absolute inset-0 [mask-image:radial-gradient(1152px_circle_at_center,white,transparent)]" />
        {/* Hero */}
      ...
      <div className="w-full sm:border-b-2 border-dashed border-neutral-300 relative">
        <div className="w-full max-w-6xl mx-auto xl:px-0 text-balance text-center xl:border-l-2 xl:border-r-2 border-dashed border-neutral-300 relative">
          <DotPattern glow={false} className="-z-10 [mask-image:radial-gradient(800px_300px_at_center,white,transparent)]" />
